...
In addition, we also support training and evaluation of the DMR method ([Dmr: Decomposed multi-modality representations for frames and events fusion in visual reinforcement learning](https://ieeexplore.ieee.org/document/10656498))
```
