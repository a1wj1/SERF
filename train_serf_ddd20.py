...
from data.dataloader_ddd20 import DDD20_Data as EV
...
if __name__ == "__main__":
    ...
    parser.add_argument('--id', type=str, default='SERF_ddd20_normal', help='Unique experiment identifier.')
    parser.add_argument('--epochs', type=int, default=150, help='Number of train epochs.')
    #
    parser.add_argument('--root_dir', type=str, default='/data2/xxxx/SERF/datasets/ddd20/export_normal_data', help='Path')
